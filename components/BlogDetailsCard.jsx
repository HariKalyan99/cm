...
const BlogDetailsCard = ({blog}) => {
  ...
  return (
    <section className='w-[100%] h-[100vh] flex justify-center items-center bg-[#A6A6A6] flex-col'>
        ...
        <div className='w-[700px] h-[auto] shadow-xl min-h-[500px] border border-[white] border-4 flex justify-evenly items-start flex-col rounded-lg overflow-hidden'>
            <img src="https://t3.ftcdn.net/jpg/07/79/50/06/360_F_779500657_m3p0kSWwxx8cCF1s2giytjcsPMksxkse.jpg" alt="blog_img" className='w-full h-[300px] object-cover'/>
          ...
          <h1 className='font-bold text-xl'>Title: <span className='text-sm'>{blog.title}</span></h1>
            ...
            <Link className='underline flex justify-center items-center gap-2' href={"/home"}>
                Go to Home<CiHome />
            </Link>
          </div>
        </div>
